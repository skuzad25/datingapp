...
//  Inthecold
//
//  Created by Shubham on 03/02/23.
//
...
public class SKActivityIndicator {
    ...
    fileprivate var statusLabelFont: UIFont = .systemFont(ofSize: 15)
    fileprivate var statusTextColor: UIColor = UIColor.black
    fileprivate var spinnerColor: UIColor = UIColor(named: "ThemeColor") ?? #colorLiteral(red: 0.9411764706, green: 0.1490196078, blue: 0.337254902, alpha: 1)
    fileprivate var backgroundViewColor: UIColor = UIColor(red: 0.0, green: 0.0, blue: 0.0, alpha: 0.2)
    fileprivate var activityIndicatorStyle: ActivityIndicatorStyle = .spinningHalfCircles
...
//        } else {
    ...
    //        }
        ...
        self.window = Singleton.sharedInstance.window
